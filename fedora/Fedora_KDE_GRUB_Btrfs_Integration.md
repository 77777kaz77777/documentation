...
```
2. Enable and start the background monitoring service (`grub-btrfsd`). This daemon automatically updates the GRUB boot menu whenever btrbk or snapper creates or deletes a snapshot:
```bash
